...
public class TicTacToe implements Runnable{
                ...
                if (spaces[i] != null) {
                    if (spaces[i].equals("X")) {
                        if (circle) {
                            ...
                            g.drawImage(blueCircle, (i % 6) * lengthOfSpace + 10 * (i % 6), (int) (i / 6) * lengthOfSpace + 10 * (int) (i / 6), null);
                        }
    ...
    private void loadImages(){
        try{
            ...
            blueCircle = ImageIO.read(getClass().getResourceAsStream("../res/blueDama.png"));
